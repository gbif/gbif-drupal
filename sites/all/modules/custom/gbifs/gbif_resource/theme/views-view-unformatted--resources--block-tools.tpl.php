...
<section id="featured-resources-rows">
  ...
  <?php endforeach; ?>
  <p class="more text-right"><a href="/resources?f[0]=gr_purpose%3A955&f[1]=gr_resource_type%3A1010&searched=1">more tools</a> about publishing data</p>
</section>
