...
/**
 * @file
 * Contains \Drupal\gbif_restful\Plugin\resource\DataProvider\DataProviderGbifParticipant.
 */
...
/**
 * Class DataProviderGbifParticipant.
 *
 * @package Drupal\gbif_restful\Plugin\resource\DataProvider
 */
class DataProviderGbifParticipant extends DataProviderEntity implements DataProviderEntityInterface {
  ...
  public function view($identifier) {
    ...
    $query->entityCondition('entity_type', 'node')
      ...
      ->fieldCondition('gp_id', 'value', $identifier);
    ...
    $field_collection = $this->initResourceFieldCollection($entity_id);
