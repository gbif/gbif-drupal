...
/**
 * @file
 * Contains \Drupal\gbif_restful\Plugin\resource\comment\Comments__1_0.
 */

namespace Drupal\gbif_restful\Plugin\resource\comment;
...
/**
 * Class Comments__1_0
 * @package Drupal\gbif_restful\Plugin\resource\comment
 *
 * @Resource(
 *   name = "comments:1.0",
 *   resource = "comments",
...
class Comments__1_0 extends ResourceEntity implements ResourceInterface {
  ...
  protected function dataProviderClassName() {
    return '\Drupal\gbif_restful\Plugin\resource\comment\DataProviderComment';
  }
