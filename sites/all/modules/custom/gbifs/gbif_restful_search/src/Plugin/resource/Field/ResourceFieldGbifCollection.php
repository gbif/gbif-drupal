...
/**
 * @file
 * Contains \Drupal\gbif_restful_search\Plugin\resource\Field\ResourceFieldGbifCollection.
 */
...
use Drupal\restful\Plugin\resource\Field\ResourceFieldResource;
...
class ResourceFieldGbifCollection extends ResourceFieldCollection implements ResourceFieldGbifCollectionInterface {
  ...
  public function __construct(array $fields = array(), RequestInterface $request) {
    $fields = parent::__construct($fields, $request);
    if (is_array($fields)) {
