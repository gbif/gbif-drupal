...
use Drupal\gbif_restful_search\Plugin\resource\DataProvider\GbifSearchApi;
 ...
 */
interface GbifResourceSearchBaseInterface extends PluginInspectionInterface, ConfigurablePluginInterface{
   ...
   *
   * @param GbifRequestInterface $request
   *   The request object.
   */
   ...
   *
   * @param ResourceFieldGbifCollectionInterface $field_definitions
   *   The field definitions to set.
   */
  public function setFieldDefinitions(ResourceFieldGbifCollectionInterface $field_definitions);
   ...
   * @param GbifResourceSearchBaseInterface $resource
   ...
   */
  public function getControllerFromPath($path = NULL, GbifResourceSearchBaseInterface $resource = NULL);
   ...
   *
   * @param GbifSearchApi $data_provider
   *   The data provider to set.
   */
  public function setDataProvider(GbifSearchApi $data_provider = NULL);
   ...
   *   The URL address.
   */
  public function getUrl(array $options = array(), $keep_query = TRUE, GbifRequestInterface $request = NULL);
